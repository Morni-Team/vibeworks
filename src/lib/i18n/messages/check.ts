...
const de = {
  ...
  ignoreHint: "Meldungen, die in deinem Projekt keine sind, nimmst du im Repository aus: eine Datei .vibeworks-check.json mit ignoreRules (Regelnamen) und ignorePaths (Pfadmuster wie src/renderer/**). Gefundene Geheimnisse bleiben immer stehen.",
  run: "Jetzt prüfen",
  running: "Läuft …",
  lastRun: "Geprüft {ago}",
...
const en: Shape<typeof de> = {
  ...
  ignoreHint: "Reports that are not a problem in your project can be excluded in the repository: a file .vibeworks-check.json with ignoreRules (rule names) and ignorePaths (patterns like src/renderer/**). Found secrets always stay.",
  run: "Check now",
  running: "Running …",
  lastRun: "Checked {ago}",
